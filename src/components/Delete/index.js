...
function Delete({ cardId, deleteCard }) {
  return (
    <div className="card__button-delete">
      <button className="delete" aria-label="delete" type="button" onClick={() => deleteCard(cardId)}>
        <svg className="delete__icon" viewBox="0 0 20 22" xmlns="http://www.w3.org/2000/svg">
